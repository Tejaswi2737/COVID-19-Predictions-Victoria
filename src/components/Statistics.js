...
import ChartNewConf from './ChartNewConf';
import ChartNewDeaths from './ChartnewDeaths';
        ...
        <Container maxWidth="lg" className={classes.container}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={4} lg={3}>
              <Paper className={fixedHeightPaper}>
                <Deposits des="Total Cases Confirmed"/>
              </Paper>
            </Grid>
            <Grid item xs={12} md={8} lg={9}>
              <Paper className={fixedHeightPaper}>
            ...
            <Grid item xs={12} md={4} lg={3}>
              <Paper className={fixedHeightPaper}>
                <Deposits des="New Cases Confirmed" />
              </Paper>
            </Grid>
            <Grid item xs={12} md={8} lg={9}>
              <Paper className={fixedHeightPaper}>
            ...
            <Grid item xs={12} md={4} lg={3}>
              <Paper className={fixedHeightPaper}>
                <Deposits des="Total Deaths Reported"/>
              </Paper>
            </Grid>  
            <Grid item xs={12} md={8} lg={9}>
              <Paper className={fixedHeightPaper}>
            ...
            <Grid item xs={12} md={4} lg={3}>
              <Paper className={fixedHeightPaper}>
                <Deposits  des="New Deaths Reported"/>
              </Paper>
            </Grid>   
